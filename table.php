...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <div class="jumbotron text-center bg-light">
        <h1 id="waktu">DAFTAR SISWA YANG SUDAH MENDAFTAR</h1>
    </div>
    <div class="container">
    ...
    <!-- Modal -->
    <div class="modal fade" id="tambah-biodata" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    <form action="proses.php" method="post">
                        <div class="form-group">
                            <input type="text" name="nama" class="form-control" placeholder="Kode Buku">
                        </div>
                        <div class="form-group">
                            <input type="text" name="alamat" class="form-control" placeholder="Judul Buku">
                        </div>
                        <div class="form-group">
                            <input type="text" name="jenis_kelamin" class="form-control" placeholder="Tahun">
                        </div>
                        <div class="form-group">
                            <input type="text" name="agama" class="form-control" placeholder="Pengarang">
                        </div>
                        <div class="form-group">
                            <input type="text" name="sekolah" class="form-control" placeholder="keterangan">
                        </div>
    ...
    <script>
        function Waktu() {
            ...
            var timing = setTimeout(Waktu, 500);
        }

        function cekWaktu(params) {
            if (angka < 10) {
                angka = "0" + angka
            };
            return angka;
